...
log using Data_Analysis_1216, replace
...
keep GEOID year geoname county state energy_community shale_community boom_growth all_shale_growth shale_geo all_comparison shale_status pop_2003 pcearn_2003 emp_2003 conspct_2003 manfpct_2003 retailpct_2003 farmpct_2003 military_2003 fed_2003 slgov_2003 pcdebt_2004 pcdebt_2007 pcdebt_2008 pcdebt_2011 pcdebt_2012 pcdebt_2016 pop_2001 pop_2007
...
*** Drop large urban population communities where energy_comunity equals 0 83
...
gen d_debt_1216_yr = (pcdebt_2016-pcdebt_2012)/4
gen dd_debt = d_debt_1216_yr - d_debt_0407_yr
...
label variable d_debt_1216 "Debt Growth in 2012-16"
label variable dd_debt "Debt Growth Difference, 2012-16 & 2004-07"
...
outreg2 using results_1216.doc, label ctitle(OLS)
...
outreg2 using results_1216.doc, append label ctitle(IPW, No Controls)

reg dd_debt all_shale_growth pcearn_2003 pop_growth_pct [pweight=w], robust
outreg2 using results_1216.doc, append label ctitle(IPW, Earnings)
...
outreg2 using results_1216.doc, append label ctitle(IPW, All Controls)
