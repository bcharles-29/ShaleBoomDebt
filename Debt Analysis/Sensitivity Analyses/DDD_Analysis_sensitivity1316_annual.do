...
log using Data_Analysis_1316, replace
...
gen pcdebt_2013 = pcdebt if year==2013
by id (year), sort: replace pcdebt_2013 = pcdebt_2013[_n-1] if missing(pcdebt_2013)
gen pcdebt_2016 = pcdebt if year==2016
by id (year), sort: replace pcdebt_2016 = pcdebt_2016[_n+1] if missing(pcdebt_2016)
...
keep GEOID year geoname county state energy_community shale_community boom_growth all_shale_growth shale_geo all_comparison shale_status pop_2003 pcearn_2003 emp_2003 conspct_2003 manfpct_2003 retailpct_2003 farmpct_2003 military_2003 fed_2003 slgov_2003 pcdebt_2004 pcdebt_2007 pcdebt_2008 pcdebt_2011 pcdebt_2013 pcdebt_2016 pop_2001 pop_2007
...
label variable pcdebt_2013 "Normalized Real Debt Stock, 2013"
label variable pcdebt_2016 "Normalized Real Debt Stock, 2016"
...
gen d_debt_1316_yr = (pcdebt_2016-pcdebt_2013)/3
gen dd_debt = d_debt_1316_yr - d_debt_0407_yr
...
label variable d_debt_1316 "Debt Growth in 2013-16"
label variable dd_debt "Debt Growth Difference, 2013-16 & 2004-07"
...
outreg2 using results_1316.doc, label ctitle(OLS)
...
outreg2 using results_1316.doc, append label ctitle(IPW, No Controls)

reg dd_debt all_shale_growth pcearn_2003 pop_growth_pct [pweight=w], robust
outreg2 using results_1316.doc, append label ctitle(IPW, Earnings)
...
outreg2 using results_1316.doc, append label ctitle(IPW, All Controls)
