...
log using Data_Analysis_1821, replace
...
*** Per Capita Inflation-Adjusted Debt
...
gen pcdebt_2018 = pcdebt if year==2018
by id (year), sort: replace pcdebt_2018 = pcdebt_2018[_n-1] if missing(pcdebt_2018)
gen pcdebt_2021 = pcdebt if year==2021
by id (year), sort: replace pcdebt_2021 = pcdebt_2021[_n+1] if missing(pcdebt_2021)
...
keep GEOID year geoname county state energy_community shale_community boom_growth all_shale_growth shale_geo all_comparison pop_2003 pcearn_2003 emp_2003 conspct_2003 manfpct_2003 retailpct_2003 farmpct_2003 military_2003 fed_2003 slgov_2003 pcdebt_2004 pcdebt_2007 pcdebt_2008 pcdebt_2011 pcdebt_2018 pcdebt_2021 pop_2001 pop_2007
...
label variable pcdebt_2018 "Normalized Real Debt Stock, 2018"
label variable pcdebt_2021 "Normalized Real Debt Stock, 2021"
...
*** Generate debt differences
gen d_debt_0407 = (pcdebt_2007-pcdebt_2004)
gen d_debt_1821 = (pcdebt_2021-pcdebt_2018)
gen dd_debt = d_debt_1821 - d_debt_0407
...
label variable d_debt_1821 "Debt Growth in 2018-21"
label variable dd_debt "Debt Growth Difference, 2018-21 & 2004-07"
...
save regression_data_1821yr.dta, replace
...
outreg2 using results_1821yr.doc, append label ctitle(IPW, No Controls)

reg dd_debt all_shale_growth pcearn_2003 pop_growth_pct [pweight=w], robust
outreg2 using results_1821yr.doc, append label ctitle(IPW, Earnings & Pop. Growth)
...
outreg2 using results_1821yr.doc, append label ctitle(IPW, All Controls)
