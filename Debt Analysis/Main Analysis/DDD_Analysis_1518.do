...
log using Data_Analysis_1518, replace
...
keep GEOID year geoname county state energy_community shale_community boom_growth all_shale_growth shale_geo all_comparison pop_2003 pcearn_2003 emp_2003 conspct_2003 manfpct_2003 retailpct_2003 farmpct_2003 military_2003 fed_2003 slgov_2003 pcdebt_2004 pcdebt_2007 pcdebt_2008 pcdebt_2011 pcdebt_2015 pcdebt_2018 pop_2001 pop_2007
...
gen d_debt_1518 = (pcdebt_2018-pcdebt_2015)
gen dd_debt = d_debt_1518 - d_debt_0407
...
label variable d_debt_1518 "Debt Growth in 2015-18"
label variable dd_debt "Debt Growth Difference, 2015-18 & 2004-07"
...
save regression_data_1518yr.dta, replace
...
outreg2 using results_1518yr.doc, append label ctitle(IPW, No Controls)

reg dd_debt all_shale_growth pcearn_2003 pop_growth_pct [pweight=w], robust
outreg2 using results_1518yr.doc, append label ctitle(IPW, Earnings & Pop. Growth)
...
outreg2 using results_1518yr.doc, append label ctitle(IPW, All Controls)
