...
log using Data_Analysis_1215yr, replace
...
gen d_debt_0407 = (pcdebt_2007-pcdebt_2004)/3
gen d_debt_1215 = (pcdebt_2015-pcdebt_2012)/3
...
save regression_data_1215yr.dta, replace
...
outreg2 using results_1215yr.doc, append label ctitle(IPW, No Controls)

reg dd_debt all_shale_growth pcearn_2003 pop_growth_pct [pweight=w], robust
outreg2 using results_1215yr.doc, append label ctitle(IPW, Earnings & Pop. Growth)
...
outreg2 using results_1215yr.doc, append label ctitle(IPW, All Controls)
