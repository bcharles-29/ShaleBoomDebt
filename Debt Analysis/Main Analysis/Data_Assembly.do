...
log using Data_Assembly, replace
...
*** What are resulting group sizes?
gen shale_status=0 
replace shale_status=1 if shale_community==0
replace shale_status=2 if shale_community==1 & all_shale_growth==0
replace shale_status=3 if shale_community==1 & all_shale_growth==1

*** Cross tabs show not enough observations to analyze shale boom communities
*** by energy community type.
tab energy_community shale_status
tab energy_community all_shale_growth
tab energy_community shale_community
tab all_shale_growth shale_community
...
save annual_debt_percapita.dta, replace
...
label variable shale_status "1 if not shale community, 2 if shale no O&G growth, 3 if shale with O&G growth"
