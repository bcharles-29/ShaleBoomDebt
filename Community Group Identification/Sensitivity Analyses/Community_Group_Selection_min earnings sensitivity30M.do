...
*DIRECTORIES
local DATA ".."
local GROUPS "Sensitivity Analyses/"

log using Community_Group_Selection_sensitivity30M, replace
...
***	Set mininum earnings level cutoff at $30M rather than $10M
local og_min_earnings 30000
...
save Community_Groups_1_sensitivity30M.dta, replace
clear
...
save Community_Groups_2_sensitivity30M.dta, replace
